...
HCThicknessList = [0.01, 0.02, 0.03]

#Monocoques

MonocoquesNamesList = ['Monocoque19mm']
...
for item1 in MonocoquesNamesList:
    for item2 in OtherProfilesNamesList:
        	...
        	for item4 in TBThicknessList:
        		for item5 in HCThicknessList:
					...
					mdb.models[ModelName].materials['Steel'].Elastic(table=((200000000000.0, 0.33), ))
                                        ...
                                        mdb.models[ModelName].Material(name='Monocoque19mm')#Done checked
                                        mdb.models[ModelName].materials['Monocoque19mm'].Density(table=((18.99, ), ))
                                        mdb.models[ModelName].materials['Monocoque19mm'].Elastic(table=((7381.67, 
                                                7406.68, 238416381.99, 0.998, 1.021e-05, 1.025e-05, 3073.29, 50439549.22, 
                                                33731303.39), ), type=ENGINEERING_CONSTANTS)
					...
					odb_path = 'H:\Dump19\\'+str(JobName)+'.odb' #CHANGE TO WORKING DIRECTORY
		...
		#######################################################Saving Data#########################################
					...
					output_file = 'H:\Thesis\Final Results\ChassisScriptOutput\TorsionalStiffnessResults19.txt'
