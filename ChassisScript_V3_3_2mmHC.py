...
MonocoquesNamesList = ['Monocoque3mm']
...
for item1 in MonocoquesNamesList:
    for item2 in OtherProfilesNamesList:
        	...
        	for item4 in TBThicknessList:
        		for item5 in HCThicknessList:
					...
					mdb.models[ModelName].materials['Steel'].Elastic(table=((200000000000.0, 0.33), ))
                                        ...
                                        mdb.models[ModelName].Material(name='Monocoque3mm')#Done checked
                                        mdb.models[ModelName].materials['Monocoque3mm'].Density(table=((38.80, ), ))
                                        mdb.models[ModelName].materials['Monocoque3mm'].Elastic(table=((40180.44, 
                                                40759.48, 1008871940.7, 0.99278, 1.30967716203e-05 , 1.33295542124e-05, 29337.59, 213763706.608, 
                                                144360905.85), ), type=ENGINEERING_CONSTANTS)
					...
					odb_path = 'H:\Dump3\\'+str(JobName)+'.odb' #CHANGE TO WORKING DIRECTORY
		...
		#######################################################Saving Data#########################################
					...
					output_file = 'H:\Thesis\Final Results\ChassisScriptOutput\TorsionalStiffnessResults3.txt'
